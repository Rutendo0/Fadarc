  ...
  const contactInfo = [
    {
      icon: MapPin,
      title: "Harare Branch",
      details: "No 3 R. Mugabe Cnr Robert Mugabe and Rotten Raw\nKopje Mall, Harare, Zimbabwe"
    },
    {
      icon: MapPin,
      title: "Bulawayo Branch",
      details: "114 George Silundika between 11th and 12th Avenue\nBulawayo, Zimbabwe"
    },
    {
      icon: Phone,
      title: "Phone Numbers",
      details: "Harare: 0779298117 / 0242770389\nBulawayo: 0772974846 / 0292883884\nGeneral: 078 228 2444"
    },
    {
      icon: Mail,
      title: "Email",
            ...
            <Card className="bg-fadarc-red rounded-xl text-white">
              <CardContent className="p-6">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-lg font-semibold">0772974846</span>
                </div>
              </CardContent>
            </Card>
          </div>
