      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-fadarc-black mb-6">
            Premium Hybrid Battery
            <span className="block text-fadarc-red">Solutions</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Discover our comprehensive range of genuine hybrid batteries and professional services, 
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-6">
              <div className="professional-card p-4 sm:p-6 text-center">
                <div className="text-2xl sm:text-3xl font-bold text-fadarc-red mb-1 sm:mb-2">2-3</div>
                <div className="text-sm sm:text-base text-gray-600 font-medium">Year Warranty</div>
              </div>
              <div className="professional-card p-4 sm:p-6 text-center">
